...
-- Dump completed on 2023-04-14 14:55:39
...
-- Dump completed on 2023-04-14 14:55:38
...
-- Dump completed on 2023-04-14 14:55:41
...
-- Dump completed on 2023-04-14 14:55:40
...
--
-- Temporary view structure for view `v_filmrating`
--

DROP TABLE IF EXISTS `v_filmrating`;
/*!50001 DROP VIEW IF EXISTS `v_filmrating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_filmrating` AS SELECT 
 1 AS `rating`,
 1 AS `count(title)`*/;
...
--
-- Temporary view structure for view `v_totalrentals`
--

DROP TABLE IF EXISTS `v_totalrentals`;
/*!50001 DROP VIEW IF EXISTS `v_totalrentals`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_totalrentals` AS SELECT 
 1 AS `monthname(rental_date)`,
 1 AS `count(rental_id)`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `v_filmcategory`
--

DROP TABLE IF EXISTS `v_filmcategory`;
/*!50001 DROP VIEW IF EXISTS `v_filmcategory`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_filmcategory` AS SELECT 
 1 AS `category_id`,
 1 AS `Name`,
 1 AS `Title`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `v_active`
--

DROP TABLE IF EXISTS `v_active`;
/*!50001 DROP VIEW IF EXISTS `v_active`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_active` AS SELECT 
 1 AS `customer_id`,
 1 AS `store_id`,
 1 AS `first_name`,
 1 AS `last_name`,
...
--
-- Temporary view structure for view `v_inactivecustomers`
--

DROP TABLE IF EXISTS `v_inactivecustomers`;
/*!50001 DROP VIEW IF EXISTS `v_inactivecustomers`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_inactivecustomers` AS SELECT 
 1 AS `customer_id`,
 1 AS `store_id`,
 1 AS `first_name`,
 1 AS `last_name`,
...
--
-- Temporary view structure for view `v_inactivecustomer`
--

DROP TABLE IF EXISTS `v_inactivecustomer`;
/*!50001 DROP VIEW IF EXISTS `v_inactivecustomer`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_inactivecustomer` AS SELECT 
 1 AS `customer_id`,
 1 AS `store_id`,
 1 AS `first_name`,
 1 AS `last_name`,
...
--
-- Temporary view structure for view `v_totalpayment`
--

DROP TABLE IF EXISTS `v_totalpayment`;
/*!50001 DROP VIEW IF EXISTS `v_totalpayment`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_totalpayment` AS SELECT 
 1 AS `country`,
 1 AS `Total_payment`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `v_active1`
--

DROP TABLE IF EXISTS `v_active1`;
/*!50001 DROP VIEW IF EXISTS `v_active1`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_active1` AS SELECT 
 1 AS `customer_id`,
 1 AS `store_id`,
 1 AS `first_name`,
 1 AS `last_name`,
...
--
-- Temporary view structure for view `v_active11`
--

DROP TABLE IF EXISTS `v_active11`;
/*!50001 DROP VIEW IF EXISTS `v_active11`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_active11` AS SELECT 
 1 AS `customer_id`,
 1 AS `store_id`,
 1 AS `first_name`,
 1 AS `last_name`,
...
--
-- Temporary view structure for view `v_activecustomers`
--

DROP TABLE IF EXISTS `v_activecustomers`;
/*!50001 DROP VIEW IF EXISTS `v_activecustomers`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_activecustomers` AS SELECT 
 1 AS `customer_id`,
 1 AS `store_id`,
 1 AS `first_name`,
 1 AS `last_name`,
...
--
-- Temporary view structure for view `v_active2`
--

DROP TABLE IF EXISTS `v_active2`;
/*!50001 DROP VIEW IF EXISTS `v_active2`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_active2` AS SELECT 
 1 AS `customer_id`,
 1 AS `store_id`,
 1 AS `first_name`,
 1 AS `last_name`,
...
--
-- Final view structure for view `v_filmrating`
--
...
/*!50001 VIEW `v_filmrating` AS select `film`.`rating` AS `rating`,count(`film`.`title`) AS `count(title)` from `film` group by `film`.`rating` */;
...
--
-- Final view structure for view `v_totalrentals`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_totalrentals` AS select monthname(`rental`.`rental_date`) AS `monthname(rental_date)`,count(`rental`.`rental_id`) AS `count(rental_id)` from `rental` where (month(`rental`.`rental_date`) = 8) group by monthname(`rental`.`rental_date`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_filmcategory`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_filmcategory` AS select `fc`.`category_id` AS `category_id`,(select `c`.`name` from `category` `c` where (`c`.`category_id` = `fc`.`category_id`)) AS `Name`,(select `f`.`title` from `film` `f` where (`f`.`film_id` = `fc`.`film_id`)) AS `Title` from `film_category` `fc` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_active`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_active` AS select `customer`.`customer_id` AS `customer_id`,`customer`.`store_id` AS `store_id`,`customer`.`first_name` AS `first_name`,`customer`.`last_name` AS `last_name`,`customer`.`email` AS `email`,`customer`.`address_id` AS `address_id`,`customer`.`active` AS `active`,`customer`.`create_date` AS `create_date`,`customer`.`last_update` AS `last_update` from `customer` where (`customer`.`active` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `v_inactivecustomers`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_inactivecustomers` AS select `customer`.`customer_id` AS `customer_id`,`customer`.`store_id` AS `store_id`,`customer`.`first_name` AS `first_name`,`customer`.`last_name` AS `last_name`,`customer`.`email` AS `email`,`customer`.`address_id` AS `address_id`,`customer`.`active` AS `active`,`customer`.`create_date` AS `create_date`,`customer`.`last_update` AS `last_update` from `customer` where (`customer`.`active` = 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `v_inactivecustomer`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_inactivecustomer` AS select `customer`.`customer_id` AS `customer_id`,`customer`.`store_id` AS `store_id`,`customer`.`first_name` AS `first_name`,`customer`.`last_name` AS `last_name`,`customer`.`email` AS `email`,`customer`.`address_id` AS `address_id`,`customer`.`active` AS `active`,`customer`.`create_date` AS `create_date`,`customer`.`last_update` AS `last_update` from `customer` where (`customer`.`active` = 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_totalpayment`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_totalpayment` AS select `cy`.`country` AS `country`,sum(`p`.`amount`) AS `Total_payment` from ((((`payment` `p` join `customer` `c` on((`p`.`customer_id` = `c`.`customer_id`))) join `address` `a` on((`a`.`address_id` = `c`.`address_id`))) join `city` `ci` on((`ci`.`city_id` = `a`.`city_id`))) join `country` `cy` on((`ci`.`country_id` = `cy`.`country_id`))) group by `cy`.`country` order by sum(`p`.`amount`) limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_active1`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_active1` AS select `customer`.`customer_id` AS `customer_id`,`customer`.`store_id` AS `store_id`,`customer`.`first_name` AS `first_name`,`customer`.`last_name` AS `last_name`,`customer`.`email` AS `email`,`customer`.`address_id` AS `address_id`,`customer`.`active` AS `active`,`customer`.`create_date` AS `create_date`,`customer`.`last_update` AS `last_update` from `customer` where ((`customer`.`active` = 1) and (`customer`.`active` = 0)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_active11`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_active11` AS select `customer`.`customer_id` AS `customer_id`,`customer`.`store_id` AS `store_id`,`customer`.`first_name` AS `first_name`,`customer`.`last_name` AS `last_name`,`customer`.`email` AS `email`,`customer`.`address_id` AS `address_id`,`customer`.`active` AS `active`,`customer`.`create_date` AS `create_date`,`customer`.`last_update` AS `last_update` from `customer` where (`customer`.`active` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_activecustomers`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_activecustomers` AS select `customer`.`customer_id` AS `customer_id`,`customer`.`store_id` AS `store_id`,`customer`.`first_name` AS `first_name`,`customer`.`last_name` AS `last_name`,`customer`.`email` AS `email`,`customer`.`address_id` AS `address_id`,`customer`.`active` AS `active`,`customer`.`create_date` AS `create_date`,`customer`.`last_update` AS `last_update` from `customer` where (`customer`.`active` = 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `v_active2`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_active2` AS select `customer`.`customer_id` AS `customer_id`,`customer`.`store_id` AS `store_id`,`customer`.`first_name` AS `first_name`,`customer`.`last_name` AS `last_name`,`customer`.`email` AS `email`,`customer`.`address_id` AS `address_id`,`customer`.`active` AS `active`,`customer`.`create_date` AS `create_date`,`customer`.`last_update` AS `last_update` from `customer` where (`customer`.`active` = 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
